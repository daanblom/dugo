          ...
          [
            {
              ...
              value: function (t) {
                var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                  s = null;
                if (
                  (p.empty(t) || p.string(t) ? (s = Array.from(document.querySelectorAll(p.string(t) ? t : 'input[type="range"]'))) : p.element(t) ? (s = [t]) : p.nodeList(t) ? (s = Array.from(t)) : p.array(t) && (s = t.filter(p.element)),
                  p.empty(s))
                )
                  return null;
                var n = a({}, r, {}, i);
      ...
      findElements() {
        try {
          return (
            ...
            (this.elements.display = { buffer: W.call(this, this.config.selectors.display.buffer), currentTime: W.call(this, this.config.selectors.display.currentTime), duration: W.call(this, this.config.selectors.display.duration) }),
            ...
            if (("captions" === r && c.appendChild(i.call(this, "captions", u)), "settings" === r && !A.empty(this.config.settings))) {
              ...
              r.appendChild(o),
                ...
                this.config.settings.forEach((i) => {
                  const s = O(
                    "button",
                    N(q(this.config.selectors.buttons.settings), { type: "button", class: `${this.config.classNames.control} ${this.config.classNames.control}--forward`, role: "menuitem", "aria-haspopup": !0, hidden: "" })
                  );
                  t.call(this, s, i),
                    J.call(this, s, "click", () => {
                      l.call(this, i, !1);
    ...
    class it {
      constructor(e) {
        t(this, "load", () => {
          ...
          t(this, "render", () => {
            (this.elements.thumb.container = O("div", { class: this.player.config.classNames.previewThumbnails.thumbContainer })),
              (this.elements.thumb.imageContainer = O("div", { class: this.player.config.classNames.previewThumbnails.imageContainer })),
              this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
            const e = O("div", { class: this.player.config.classNames.previewThumbnails.timeContainer });
            (this.elements.thumb.time = O("span", {}, "00:00")),
              ...
              (this.elements.scrubbing.container = O("div", { class: this.player.config.classNames.previewThumbnails.scrubbingContainer })),
              ...
              () => {
                ...
                Object.assign(this, { provider: s, type: i, supported: Y.check(i, s, this.config.playsinline), media: O(a, r) }),
                  ...
                  A.empty(e.previewThumbnails) ||
                    ...
                    this.config.previewThumbnails.enabled && (this.previewThumbnails = new it(this))),
